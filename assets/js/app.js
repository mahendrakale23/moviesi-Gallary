...
var moviesData=document.getElementById("moviesData")
var result="";

movieArray.forEach(function(movieElement,i){
	result+=`<div class="col-sm-4 mb-5 float-left">
		   <figure class="Movies">
			<img src="https://image.tmdb.org/t/p/w1280${movieElement.poster_path}"alt="image"title="image" class="img-fluid">
											 
            <figcaption>
			<div class="movie-info">
			<div class="row">
			<div class="col-sm-8">
			<h3>Title:${movieElement.title}</h3>
			</div>
			<div class="col-sm-4">
			<span> Rating:${movieElement.vote_average} </span>
			</div>
			</div>
			</div>   
			<div class="overview">
			<h3>overview</h3>
			<p class="info">  ${movieElement.overview} </p>
			</div>   
